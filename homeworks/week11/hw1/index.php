    ...
    <div class="comments">
      <?php
        ...
        <div class="comment"> 
          ...
          <?php
            $parent_id = $row['id'];
            $sql_sub = "SELECT c.id, c.content, c.created_at, u.nickname FROM wanwan418_comments as c LEFT JOIN wanwan418_users as u ON c.username = u.username
          ...
          ?> 
            <div class="Subcomment">
              <div class="SubcommentTime"><?php echo $row_sub['created_at']?></div>
              <div class="SubcommentUser"><?php echo $row_sub['nickname']?> 回覆</div>
              <div class="SubcommentMsg"><?php echo $row_sub['content']?></div>
              <?php 
          ...
          ?>
            <div class="replyMsg">
              ...
              <form action="./add_comment.php" method="post">
                ...
                <textarea placeholder="在這裡輸入吧" rows="8" cols="70" name="content"></textarea>
                <?php if($user) {
                  echo "<input type='submit' value='大力按下去' class='buttonMain'>";
                } else {
                  echo "<input type='button' value='請先註冊或登入' class='buttonMain'>";
